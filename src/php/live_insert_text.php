<?php
    ...
    // php的欄位全部都大寫
    $sql = "INSERT INTO LIVE_BOARD(CONTENT, STATUS, COMPANY_ID, GUEST_ID, AGENDA_ID) VALUES (:CONTENT, :STATUS, :COMPANY_ID, :GUEST_ID, (SELECT ID FROM TFD105_G5.AGENDA where date = CURDATE() and HOUR(START_TIME) <= HOUR(now()) and HOUR(END_TIME)>= HOUR(now())))";

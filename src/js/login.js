document.addEventListener("DOMContentLoaded", function () {
    ...
    let companySignInContainer = document.getElementById(
        "company-sign-in-container"
    );
    let companySignUpContainer = document.getElementsByClassName(
        "company-sign-up-container"
    )[0];
    let guestSignInContainer = document.getElementsByClassName(
        "guest-sign-in-container"
    )[0];
    ...
    login_btn_signup.addEventListener("click", function () {
        ...
        if (
            $("#company-sign-in-container").hasClass("js-slide-right") &&
            $("#company-sign-in-container").hasClass("js-block")
        ) {
            // 初始化流程
            companySignInContainer.classList.remove("js-slide-right");
        ...
        if (
            $("#company-sign-in-container").hasClass("js-slide-right") &&
            $("#company-sign-in-container").hasClass("js-slide-left") &&
            $("#company-sign-in-container").hasClass("js-none") &&
            $("#company-sign-in-container").hasClass("js-block2")
        ) {
            companySignInContainer.classList.remove("js-slide-right");
            // companySignInContainer.classList.add('js-slide-left');
            companySignUpContainer.classList.remove("js-none");
    ...
    forgetA.addEventListener("click", function () {
        ...
        if (
            $("#company-sign-in-container").hasClass("js-slide-right") &&
            $("#company-sign-in-container").hasClass("js-block") &&
            $("#company-sign-in-container").hasClass("js-block3") &&
            $("#company-sign-in-container").hasClass("js-slide-left")
        ) {
